...
if (is_siteadmin() || $userroleid==1){// go to change for
...
$mform->set_data($toform);	
	...
	if ($newuserid==""){
		echo "</br> New message; Select and click select button to select a user for this project idea ";
	}
...
if (is_siteadmin() || getuserroleid($userid, $coursecontext)==1 ){
	...
	$managertypeuser =true;
	} else { $newuserid = $USER->id;
	}
