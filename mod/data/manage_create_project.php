...
$PAGE->set_url('/mod/data/manage_create_project.php');
...
$mform = new changeuser_form( null, array( 'convertuserrole'=>$convertuserrole,'recordusername'=>$recordusername, 'recoruserdid'=>$recorduserid, 'recordid'=>$recordid, 'dataid'=>$dataid ,'courseid'=>$courseid,'recordtitle'=>$recordtitle ));//name of the form you defined in file above.
...
echo "<br> studentid xxx $studentdetails->id";
echo "</br> supervisorid xx $supervisordetails->id";
