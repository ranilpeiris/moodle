...
/**
 * The mod_idea field deleted event.
 *
 * @package    mod_idea
...
/**
 * The mod_idea field deleted event class.
 *
...
class field_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventfielddeleted', 'mod_idea');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the field with id '$this->objectid' in the idea activity " .
    ...
    public function get_legacy_logidea() {
        return array($this->courseid, 'idea', 'fields delete', 'field.php?d=' . $this->other['ideaid'],
