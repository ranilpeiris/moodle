...
/**
 * The mod_idea field created event.
 *
 * @package    mod_idea
 * @since      Moodle 2.7
...
/**
 * The mod_idea field created event class.
 *
...
class field_created extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'idea_fields';
        $this->data['crud'] = 'c';
    ...
    public static function get_name() {
        return get_string('eventfieldcreated', 'mod_idea');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the field with id '$this->objectid' for the idea activity " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/idea/field.php', array('d' => $this->other['ideaid']));
    }
    ...
    public function get_legacy_logidea() {
        return array($this->courseid, 'idea', 'fields add', 'field.php?d=' . $this->other['ideaid'] . '&amp;mode=display&amp;fid=' .
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'idea_fields', 'restore' => 'idea_field');
    }
