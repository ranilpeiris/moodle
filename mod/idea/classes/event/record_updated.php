...
/**
 * The mod_idea record updated event.
 *
 * @package    mod_idea
...
/**
 * The mod_idea record updated event class.
 *
...
class record_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventrecordupdated', 'mod_idea');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the idea record with id '$this->objectid' in the idea activity " .
    ...
    public function get_legacy_logidea() {
        return array($this->courseid, 'idea', 'update', 'view.php?d=' . $this->other['ideaid'] . '&amp;rid=' . $this->objectid,
