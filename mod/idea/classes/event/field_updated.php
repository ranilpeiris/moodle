...
/**
 * The mod_idea field updated event.
 *
 * @package    mod_idea
...
/**
 * The mod_idea field updated event class.
 *
...
class field_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventfieldupdated', 'mod_idea');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the field with id '$this->objectid' in the idea activity " .
    ...
    public function get_legacy_logidea() {
        return array($this->courseid, 'idea', 'fields update', 'field.php?d=' . $this->other['ideaid'] .
