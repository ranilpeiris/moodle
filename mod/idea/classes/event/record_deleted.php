...
/**
 * The mod_idea record deleted event.
 *
 * @package    mod_idea
...
/**
 * The mod_idea record deleted event class.
 *
...
class record_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventrecorddeleted', 'mod_idea');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the idea record with id '$this->objectid' in the idea activity " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/idea/view.php', array('d' => $this->other['ideaid']));
    }
    ...
    public function get_legacy_logidea() {
        return array($this->courseid, 'idea', 'record delete', 'view.php?id=' . $this->contextinstanceid,
