...
/**
 * The mod_idea template viewed event.
 *
 * @package    mod_idea
...
/**
 * The mod_idea template viewed event class.
 *
...
class template_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventtemplateviewed', 'mod_idea');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the template for the idea activity with course module " .
    ...
    public function get_legacy_logidea() {
        return array($this->courseid, 'idea', 'templates view', 'templates.php?id=' . $this->contextinstanceid .
