...
/**
 * Strings for component 'idea', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_idea
...
$string['availabletags_help'] = 'Tags are placeholders in the template, which will be replaced by idea or other items, such as an edit icon, when entries are edited or viewed.
...
$string['calendarend'] = 'ideabase {$a} closes';
$string['calendarstart'] = 'ideabase {$a} opens';
...
$string['configenablerssfeeds'] = 'This switch will enable the possibility of RSS feeds for all ideabases. You will still need to turn feeds on manually in the settings for each ideabase.';
...
$string['csvfailed'] = 'Unable to read the raw idea from the CSV file';
$string['csvfile'] = 'CSV file';
$string['csvimport'] = 'CSV file import';
$string['csvimport_help'] = 'Entries may be imported via a plain text file with a list of field names as the first line, then the idea, with one record per line.';
$string['csvwithselecteddelimiter'] = '<acronym title="Comma Separated Values">CSV</acronym> text with selected delimiter:';
$string['idea:addinstance'] = 'Add a new ideabase';
$string['idea:approve'] = 'Approve and undo approved entries';
$string['idea:comment'] = 'Write comments';
$string['idea:exportallentries'] = 'Export all ideabase entries';
$string['idea:exportentry'] = 'Export a ideabase entry';
$string['idea:exportownentry'] = 'Export own ideabase entry';
$string['idea:exportuserinfo'] = 'Export user information';
$string['idea:managecomments'] = 'Manage comments';
$string['idea:manageentries'] = 'Manage entries';
$string['idea:managetemplates'] = 'Manage templates';
$string['idea:manageuserpresets'] = 'Manage all template presets';
$string['idea:rate'] = 'Rate entries';
$string['idea:readentry'] = 'Read entries';
$string['idea:viewalluserpresets'] = 'View presets from all users';
$string['idea:viewallratings'] = 'View all raw ratings given by individuals';
$string['idea:viewanyrating'] = 'View total ratings that anyone received';
$string['idea:viewentry'] = 'View entries';
$string['idea:viewrating'] = 'View the total rating you received';
$string['idea:writeentry'] = 'Write entries';
$string['idea:view'] = 'View ideabase activity';
$string['date'] = 'Date';
...
$string['example'] = 'ideabase module example';
$string['excel'] = 'Excel';
...
$string['fieldmappings_help'] = 'This menu allows you to keep the idea from the existing ideabase. To preserve the idea in a field, you must map it to a new field, where the idea will appear. Any field can also be left blank, with no infomation copied into it. Any old field not mapped to a new one will be lost and all it\'s idea removed.
...
$string['fieldnotmatched'] = 'The following fields in your file are not known in this ideabase: {$a}';
...
$string['filtername'] = 'ideabase auto-linking';
...
$string['insufficiententries'] = 'more entries needed to view this ideabase';
...
$string['invalidid'] = 'Incorrect idea ID';
...
$string['mappingwarning'] = 'All old fields not mapped to a new field will be lost and all idea in that field will be removed.';
...
$string['missingidea'] = 'idea id or object must be provided to field class';
$string['missingfield'] = 'Programmer error: You must specify field and/or idea when defining field class.';
$string['modulename'] = 'ideabase';
$string['modulename_help'] = 'The ideabase activity module enables participants to create, maintain and search a collection of entries (i.e. records).  The structure of the entries is defined by the teacher as a number of fields. Field types include checkbox, radio buttons, dropdown menu, text area, URL, picture and uploaded file.

The visual layout of information when listing, viewing or editing ideabase entries may be controlled by ideabase templates. ideabase activities may be shared between courses as presets and a teacher may also import and export ideabase entries.

If the ideabase auto-linking filter is enabled, any entries in a ideabase will be automatically linked where the words or phrases appear within the course.
...
ideabase activities have many uses, such as
...
$string['modulename_link'] = 'mod/idea/view';
$string['modulenameplural'] = 'ideabases';
$string['more'] = 'More';
...
$string['newfield_help'] = 'A field allows the input of idea. Each entry in a ideabase activity can have multiple fields of multiple types such as a date field, which allows participants to select a day, month and year from a dropdown list, a picture field, which allows participants to upload an image file, or a checkbox field, which allows participants to select one or more options.
...
$string['nofieldinideabase'] = 'There are no fields defined for this ideabase.';
...
$string['norecords'] = 'No entries in ideabase';
...
$string['page-mod-idea-x'] = 'Any ideabase activity module page';
$string['pagesize'] = 'Entries per page';
$string['participants'] = 'Participants';
$string['picture'] = 'Picture';
$string['pleaseaddsome'] = 'Please create some below or <a href="{$a}">choose a predefined set</a> to get started.';
$string['pluginadministration'] = 'ideabase activity administration';
$string['pluginname'] = 'ideabase';
$string['portfolionotfile'] = 'Export to a portfolio rather than a file (csv and leap2a only)';
$string['presetinfo'] = 'Saving as a preset will publish this template. Other users may be able to use it in their ideabases.';
...
Note: If entries are required before viewing, the ideabase auto-linking filter should be disabled. This is because the ideabase auto-linking filter can\'t determine whether a user has submitted the required number of entries.';
...
$string['search:activity'] = 'ideabase - activity information';
$string['search:entry'] = 'ideabase - entries';
...
$string['subplugintype_ideafield'] = 'ideabase field type';
$string['subplugintype_ideafield_plural'] = 'ideabase field types';
$string['subplugintype_ideapreset'] = 'Preset';
$string['subplugintype_ideapreset_plural'] = 'Presets';
...
$string['toideabase'] = 'to this ideabase.';
$string['type'] = 'Field type';
$string['undefinedprocessactionmethod'] = 'No action method defined in idea_Preset to handle action "{$a}".';
...
* Each record is a series of idea separated by commas (or other delimiters)
...
$string['uploadrecords_link'] = 'mod/idea/import';
$string['url'] = 'Url';
...
$string['wrongideaid'] = 'Wrong idea id provided';
