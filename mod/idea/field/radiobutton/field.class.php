...
class idea_field_radiobutton extends idea_field_base {
    ...
    function display_add_field($recordid = 0, $formidea = null) {
        ...
        if ($formidea) {
            ...
            $content = trim($DB->get_field('idea_content', 'content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid)));
        } else {
            $content = '';
        }
        ...
        foreach ($options as $radio) {
            ...
            $str .= 'value="' . s($radio) . '" class="mod-idea-input m-r-1" ';
     ...
     function display_search_field($value = '') {
        ...
        $return = html_writer::label(get_string('fieldtypelabel', "ideafield_" . $this->type),
