...
class idea_field_menu extends idea_field_base {
    ...
    function display_add_field($recordid = 0, $formidea = null) {
        ...
        $str .= '</label>';
        $str .= html_writer::select($options, 'field_'.$this->field->id, $content, array('' => get_string('menuchoose', 'idea')),
                                    array('id' => 'field_'.$this->field->id, 'class' => 'mod-idea-input custom-select'));
