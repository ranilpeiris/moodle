...
class idea_field_checkbox extends idea_field_base {
    ...
    function display_add_field($recordid = 0, $formidea = null) {
        ...
        foreach (explode("\n", $this->field->param1) as $checkbox) {
            ...
            $str .= 'value="' . s($checkbox) . '" class="mod-idea-input m-r-1" ';
    ...
    function display_search_field($value='') {
        ...
        $requiredstr = get_string('selectedrequired', 'idea');
    ...
    function update_content($recordid, $value, $name='') {
        ...
        $content->content = $this->format_idea_field_checkbox_content($value);
    ...
    function format_idea_field_checkbox_content($content) {
        if (!is_array($content)) {
            return NULL;
        }
        $options = explode("\n", $this->field->param1);
