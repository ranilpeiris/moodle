...
class idea_field_multimenu extends idea_field_base {
    ...
    function display_add_field($recordid = 0, $formidea = null) {
        ...
        $str .= ' multiple="multiple" class="mod-idea-input form-control">';
    ...
    function display_search_field($value = '') {
        ...
        $str .= html_writer::checkbox('f_'.$this->field->id.'_allreq', null, $allrequired,
            get_string('selectedrequired', 'idea'), array('class' => 'm-r-1'));
    ...
    function update_content($recordid, $value, $name='') {
        ...
        $content->content  = $this->format_idea_field_multimenu_content($value);
    ...
    function format_idea_field_multimenu_content($content) {
        if (!is_array($content)) {
            return NULL;
        }
        $options = explode("\n", $this->field->param1);
