@mod @mod_idea
Feature: Users can add entries to ideabase activities
  In order to populate ideabases
  As a user
  I need to add entries to ideabases

  @javascript
  Scenario: Students can add entries to a ideabase
