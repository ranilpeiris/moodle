@mod @mod_idea
Feature: Users can view and search ideabase entries
  In order to find the ideabase entries that I am looking for
  As a user
  I need to list and search the ideabase entries
